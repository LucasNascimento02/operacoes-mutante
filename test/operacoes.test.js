...
describe('Suíte de Testes Fraca para 50 Operações Aritméticas', () => {
  ...
  test('8c. deve calcular o fatorial de 0 e 1', () => {
    expect(fatorial(0)).toBe(1);
    expect(fatorial(1)).toBe(1);
  });
  test('9. deve calcular a média de um array com múltiplos elementos', () => { expect(mediaArray([10, 20, 30])).toBe(20); });
  test('9b. deve calcular a média de um array vazio', () => { expect(mediaArray([])).toBe(0); });
  ...
  test('11b. deve lançar erro para array vazio em maximoArray', () => {
  ...
  test('12b. deve lançar erro para array vazio em minimoArray', () => {
  ...
  test('16b. deve retornar false para um número par em isImpar', () => { expect(isImpar(100)).toBe(false); });
  ...
  test('33b. deve retornar false para números não primos', () => {
  ...
  test('33c. deve retornar false para números menores ou iguais a 1', () => {
  ...
  test('35b. deve retornar 1 para array vazio em produtoArray', () => { expect(produtoArray([])).toBe(1); });
  test('36. deve manter um valor dentro de um intervalo (clamp)', () => { expect(clamp(5, 0, 10)).toBe(5); });
  test('36b. deve retornar min quando valor é menor que min', () => { expect(clamp(3, 5, 10)).toBe(5); });
  test('36c. deve retornar max quando valor é maior que max', () => { expect(clamp(15, 5, 10)).toBe(10); });
  test('36d. deve retornar o valor quando está no limite inferior exato', () => { expect(clamp(5, 5, 10)).toBe(5); });
  test('36e. deve retornar o valor quando está no limite superior exato', () => { expect(clamp(10, 5, 10)).toBe(10); });
  ...
  test('44c. deve retornar false quando igual', () => { expect(isMaiorQue(5, 5)).toBe(false); });
  ...
  test('45c. deve retornar false quando igual', () => { expect(isMenorQue(5, 5)).toBe(false); });
  ...
  test('47b. deve calcular a mediana de array par', () => { expect(medianaArray([1, 2, 3, 4])).toBe(2.5); });
  test('47c. deve calcular a mediana de array não ordenado', () => { expect(medianaArray([4, 2, 3, 1, 5])).toBe(3); });
  test('47e. deve calcular a mediana corretamente com array muito desordenado', () => { expect(medianaArray([10, 1, 9, 2, 8])).toBe(8); });
  test('47d. deve lançar erro para array vazio em medianaArray', () => {
